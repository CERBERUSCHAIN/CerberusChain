...
$dockerComposeLines | Out-File -FilePath "docker-compose.yml" -Encoding UTF8
...
$cargoLines | Out-File -FilePath "backend/Cargo.toml" -Encoding UTF8
...
$mainRsLines | Out-File -FilePath "backend/src/main.rs" -Encoding UTF8
...
$libRsLines | Out-File -FilePath "backend/src/lib.rs" -Encoding UTF8
...
$packageJsonLines | Out-File -FilePath "frontend/package.json" -Encoding UTF8
...
$indexHtmlLines | Out-File -FilePath "frontend/index.html" -Encoding UTF8
...
$backendDockerLines | Out-File -FilePath "backend/Dockerfile" -Encoding UTF8
...
$frontendDockerLines | Out-File -FilePath "frontend/Dockerfile" -Encoding UTF8
...
$workspaceLines | Out-File -FilePath "cerberus-hydra.code-workspace" -Encoding UTF8
